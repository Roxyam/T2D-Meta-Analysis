...
## Batch
batch = factor(str_split_i(pD1$Source.Name, pattern = " ", i=3))
...
```{r echo=TRUE, results = "hide", eval=TRUE, message=FALSE, warning=FALSE}
# Guardamos los datos anotados
E_MEXP_1425_norm2 = normData2
save(E_MEXP_1425_norm2, normData2, file = glue("{DirRData}/normData2.RData"))
```  
...
```{r echo=TRUE, results = "hide", eval=TRUE, message=FALSE, warning=FALSE}
# Guardamos los datos anotados
E_MEXP_1425_norm2_anot = normData2_anot
save(E_MEXP_1425_norm2_anot, normData2_anot, file = glue("{DirRData}/normData2_anot.RData"))
```   
...
E_MEXP_1425_final = finalData = normData2_anot
save(E_MEXP_1425_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
...
En este caso nos quedamos con los datos normalizados proporcionados en el estudio.  
```{r echo=TRUE, results = "hide", eval=TRUE, message=FALSE, warning=FALSE}
# Cargamos los datos
load(glue("{DirRData}/rawData.RData"))
```  
...
GSE20950_final = finalData = normData2_anot
save(GSE20950_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
...
```{r echo=TRUE, results = "hide", eval=TRUE, message=FALSE, warning=FALSE}
# Guardamos los datos anotados
GSE29718_norm2 = normData2
save(GSE29718_norm2, normData2, file = glue("{DirRData}/normData2.RData"))
```  
...
```{r echo=TRUE, results = "hide", eval=TRUE, message=FALSE, warning=FALSE}
# Guardamos los datos anotados
GSE29718_norm2_anot = normData2_anot
save(GSE29718_norm2_anot, normData2_anot, file = glue("{DirRData}/normData2_anot.RData"))
```   
...
# Guardamos los datos anotados
load(glue("{DirRData}/normData2_anot.RData"))
GSE29718_final = finalData = normData2_anot
save(GSE29718_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
...
# Guardamos los datos anotados
load(glue("{DirRData}/normData_anot.RData"))
GSE64567_final = finalData = normData_anot
save(GSE64567_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
...
# Guardamos los datos anotados
load(glue("{DirRData}/normData_anot.RData"))
GSE78721_final = finalData = normData_anot
save(GSE78721_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
...
# Guardamos los datos anotados
load(glue("{DirRData}/normData_anot.RData"))
GSE141432_final = finalData = normData_anot
save(GSE141432_final, finalData, file = glue("{DirRData}/finalData.RData"))
```   
...
# Guardamos los datos anotados
load(glue("{DirRData}/normData_anot.RData"))
GSE205668_final = finalData = normData_anot
save(GSE205668_final, finalData, file = glue("{DirRData}/finalData.RData"))
```  
