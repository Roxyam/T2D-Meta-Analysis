...
En este documento se muestran los resultados del metaanálisis de los estudios: GSE20950, GSE141432 para el contraste Ob_IR - Ob_IS.  
&nbsp;  


Tomando un p valor ajustado por BH < 0.05 encontramos 1652 genes significativos.  
&nbsp;  
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
DT = get(load("/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Diabetes/ID/Meta-analysis_1_DF.RData"))
...
path = "/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Diabetes/ID/Plots"
