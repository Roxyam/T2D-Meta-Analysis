...
This document shows the results of the meta-analysis of the studies: GSE20950, GSE141432 para el contraste T2D.M - Ob.M.  
&nbsp;  


Taking a p-value adjusted for BH < 0.05 we found 322 significative genes.  
&nbsp;  
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
DT = get(load("C:/Users/roxya/OneDrive/Documentos/01Master_bioinformatica/00TFM/05Paper/AnalysisGit/Data/MA/Diabetes/IDM/Meta-analysis_IDM_DF.RData"))
...
path = "C:/Users/roxya/OneDrive/Documentos/01Master_bioinformatica/00TFM/05Paper/AnalysisGit/Data/MA/Diabetes/IDM/Plots"
files <- list.files(path = path, pattern = "Meta-analysis_IDM.*forest")
