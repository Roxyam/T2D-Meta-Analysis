...
En este documento se muestran los resultados del metaanálisis de los estudios: E_MEXP_1425, GSE2508, GSE29718, GSE64567, GSE92405, GSE141432, GSE205668 para el contraste Ob_IS - Np_IS.  
&nbsp;  


Tomando un p valor ajustado por BH < 0.05 encontramos 780 genes significativos.  
&nbsp;  
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
DT = get(load("/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Obesity/IO/Meta-analysis_1_DF.RData"))
...
path = "/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Obesity/IO/Plots"
files <- list.files(path = path, pattern = "Meta-analysis_1.*forest")
