...
This document shows the results of the meta-analysis of the studies: E_MEXP_1425, GSE2508, GSE29718, GSE64567, GSE92405, GSE141432, GSE205668 para el contraste Ob.F - C.F.  
&nbsp;  


Taking a p-value adjusted for BH < 0.05 we found 310 significative genes.  
&nbsp;  
...
path = "C:/Users/roxya/OneDrive/Documentos/01Master_bioinformatica/00TFM/05Paper/AnalysisGit/Data/MA/Obesity/IOF/Plots"
files <- list.files(path = path, pattern = "Meta-analysis_IOF.*forest")
