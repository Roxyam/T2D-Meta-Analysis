...
Taking a p-value adjusted for BH < 0.05 we found 414 significative genes.  
&nbsp;  
...
path = "C:/Users/roxya/OneDrive/Documentos/01Master_bioinformatica/00TFM/05Paper/AnalysisGit/Data/MA/Obesity/IOM/Plots"
files <- list.files(path = path, pattern = "Meta-analysis_IOM.*forest")
