...
En este documento se muestran los resultados del metaanálisis de los estudios: E_MEXP_1425, GSE2508, GSE29718, GSE64567, GSE92405, GSE141432, GSE205668 para el contraste (Ob_IS.M - Np_IS.M) - (Ob_IS.F - Np_IS.F).  
&nbsp;  


Tomando un p valor ajustado por BH < 0.05 encontramos 19 genes significativos.  
&nbsp;  
...
```{r echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
DT = get(load("/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Obesity/SDIO/Meta-analysis_4_DF.RData"))
...
path = "/home/rmoldovan/T2D-Meta-Analysis/Data/MA/Obesity/SDIO/Plots"
files <- list.files(path = path, pattern = "Meta-analysis_4.*forest")
